...
class _HotelDetailState extends State<HotelDetail>
  ...
  Future<void> fetchRoomDetails() async {
    final url =
        Uri.parse('http://192.168.0.47:5000/api/rooms/${widget.roomId}');
    try {
  ...
  Future<void> checkFavoriteStatus() async {
    final url =
        Uri.parse("http://192.168.0.47:5000/api/wishlist/${widget.userId}");
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
  ...
  Future<void> toggleFavorite() async {
    final url = Uri.parse("http://192.168.0.47:5000/api/wishlist");
    try {
  ...
  Future<void> fetchAndSetReviews() async {
    final url =
        Uri.parse('http://192.168.0.47:5000/api/reviews/${widget.roomId}');
    final response = await http.get(url);
    if (response.statusCode == 200) {
...
Future<List<dynamic>> fetchReviews(String roomId) async {
  final url = Uri.parse('http://192.168.0.47:5000/api/reviews/$roomId');
  final response = await http.get(url);
...
class _GuestSelectionBottomSheetState extends State<GuestSelectionBottomSheet> {
  ...
  Future<void> bookRoom() async {
    final url = Uri.parse('http://192.168.0.47:5000/api/bookings');
