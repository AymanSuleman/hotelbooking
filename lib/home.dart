...
//     final url = Uri.parse('http://192.168.0.39:5000/api/featured');
//     try {
...
//     final url = Uri.parse('http://192.168.0.39:5000/api/popular-stays');
//     try {
//       final response = await http.get(url);
//       if (response.statusCode == 200) {
//         final List<dynamic> data = json.decode(response.body);
...
//     final url = Uri.parse('http://192.168.0.39:5000/api/other-stays');
//     try {
//       final response = await http.get(url);
//       if (response.statusCode == 200) {
//         final List<dynamic> data = json.decode(response.body);
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchRoomsByCategory(
    ...
    final url =
        Uri.parse('http://192.168.0.39:5000/api/rooms/category/$category');
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
        final List<dynamic> data = json.decode(response.body);
